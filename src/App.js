        ...
        <div className="grid">
          ...
          <nav className="header__navbar">
            <ul className="header__navbar-list">
              <li className="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">Vào cửa hàng trên ứng dụng F8-Shop
                <div className="header__qr">
                  <img src="./assets/img/qr.png" alt="QR code" className="header__qr-img" />
                  <div className="header__qr-apps">
                    <a href className="header__qr-link">
                      <img src="./assets/img/google_paly.png" alt="Google Play" className="header__qr-download-img" />
                    </a>
                    <a href className="header__qr-link">
              ...
              <li className="header__navbar-item header__navbar-item--has-qr">
                ...
                <div className="header__notify">
                  ...
                  <ul className="header__notyfi-list">
                    <li className="header__notify-item header__notify-item--viewed">
                      <a className="header__notyfi-link">
                        <img src="./assets/img/notify1.jpeg" alt="" className="header__notyfi-img" />
                        <div className="header__notyfi-info">
                          <span className="header__notyfi-name">Mỹ phẩm Ohui chính hãng</span>
                          <span className="header__notyfi-description">Mô tả sản phảm chính
                            hãng</span>
                        </div>
                      </a>
                    </li>
                    ...
                    <li className="header__notify-item">
                      <a className="header__notyfi-link">
                        ...
                        <div className="header__notyfi-info">
                          <span className="header__notyfi-name">Mỹ phẩm Ohui chính hãngMỹ phẩm Ohui
                            chính hãngMỹ phẩm Ohui chính hãngMỹ phẩm Ohui chính hãng
                          </span>
                          <span className="header__notyfi-description">Mô tả sản phảm chính hãngMỹ
                            phẩm Ohui chính hãngMỹ phẩm Ohui chính hãngMỹ phẩm Ohui chính
                            hãng</span>
                        </div>
                      </a>
                    </li>
                  ...
                  <footer className="header__notify-footer">
                    <a href className="header__notify--footer-btn"><span>Xem tất cả</span></a>
                  </footer>
                </div>
              </li>
              <li className="header__navbar-item">
                <a className="header__navbar-item-link">
                  <i className="header__navbar-icon far fa-question-circle" /> Trợ giúp</a>
              </li>
              {/* user khi dang nhap */}
              {/* <li class="header__navbar-item header__navbar-item--strong header__navbar-item--separate">Đăng kí</li>
                        <li class="header__navbar-item header__navbar-item--strong">Đăng nhập</li> */}
              <li className="header__navbar-item header__navbar-user">
                <img src="./assets/img/user.png" alt="" className="header__navbar-user-img" />
            ...
            <div className="header__cart">
              <div className="header__cart-wrap">
                ...
                <div className="header__cart-list">
                  <img src="./assets/img/nocart.jpg" className="header__cart-no-cart-img" alt="" />
                  ...
                  <div className="header__cart-have-cart">
                    ...
                    <ul className="header__cart-list-item">
                      <li className="header__cart-item">
                        <img src="./assets/img/notify1.jpeg" alt="" className="header__cart-img" />
                        <div className="header__cart-item-info">
                          <div className="header__cart-item-head">
                            <h5 className="header__cart-item-name">Bộ kem đặ dgdfg dfc vị vùng mắt
                            </h5>
                      ...
                      <li className="header__cart-item">
                        ...
                        <div className="header__cart-item-info">
                          <div className="header__cart-item-head">
                            <h5 className="header__cart-item-name">Bộ kem đặ dgdfg dfc vị vùng mắtBộ kem đặ dgdfg dfc vị vùng mắtBộ kem đặ dgdfg dfc vị vùng mắtBộ kem đặ dgdfg dfc vị vùng mắtBộ kem đặ dgdfg dfc vị vùng mắtBộ kem đặ dgdfg dfc vị vùng mắt</h5>
                            <div className="header__cart-price-wrap">
                              <span className="header__cart-item-price">2.000.000đ</span>
                              <span className="header__cart-item-multiply">X</span>
                              <span className="header__cart-item-qnt">1</span>
                    ...
                    <button className="header__cart-viewcart btn btn-primary">Xem giỏ hàng</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid__column-10">
                ...
                <div className="grid__row">
                  <div className="grid__column-2-4">
                    ...
                    <a className="home-poduct-item">
                      <div className="home-product-item__img" style={{ backgroundImage: 'url(./assets/img/sp1.jpeg)' }} />
                      <h4 className="home-product-item__name">Chân váy hoa nhí kèm hoa nhí kèm hoa nhí kèm hình thật bảng màu ở cuối</h4>
                      ...
                      <div className="home-product-item__origin">
                        <div className="home-product-item__brand">Whoo
                        </div>
              ...
              <div className="pagination home-product__pagination">
                <li className="pagination-item">
                  <a href className="pagination-item__link pagination">
                    <i href className="pagination-item__icon fas fa-angle-left" />
                  </a>
                </li>
                ...
                <li className="pagination-item">
                  <a href className="pagination-item__link">13</a>
                </li>
                <li className="pagination-item">
                  <a href className="pagination-item__link">
                    <i href className="pagination-item__icon fas fa-angle-right" />
                  </a>
                </li>
              </div>
            </div>
          ...
          <div className="grid__row">
            <div className="grid__column-2-4">
              ...
              <ul className="footer-list">
                ...
                <li className="footer-item" />
                <a href className="footer-item__link">Hưỡng Dẫn Mua Hàng</a>
              </ul>
            </div>
            <div className="grid__column-2-4">
              <h3 className="footer__heading">
              ...
              <ul className="footer-list">
                ...
                <li className="footer-item" />
                <a href className="footer-item__link">Mua Hàng</a>
                <li className="footer-item" />
            ...
            <div className="grid__column-2-4">
              ...
              <ul className="footer-list">
                ...
                <li className="footer-item" />
                <a href className="footer-item__link">Đồ Gia Dụng</a>
              </ul>
            </div>
            <div className="grid__column-2-4">
              <h3 className="footer__heading">
              ...
              <ul className="footer-list">
                ...
                <li className="footer-item" />
                <a href className="footer-item__link">
                  <i className="footer-item__icon  fab fa-linkedin" />LikedIn
                </a>
              </ul>
            </div>
            <div className="grid__column-2-4">
              ...
              <div className="footer__download">
                <img src="./assets/img/qr.png" alt="" className="footer__download-qr" />
                <div className="footer__download-apps">
                  <a href className="footer__download-app-link">
                    <img src="./assets/img/google_paly.png" alt="Google play" className="footer_downlaod-app-img" />
                  </a>
                  <a href className="footer__download-app-link">
                    <img src="./assets/img/app_store.png" alt="App store" className="footer_downlaod-app-img" />
                  </a>
                </div>
              </div>
            </div>
